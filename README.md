...
<picture>
  ...
  <img alt="Ayed Almudarra — Software Engineer · Riyadh, Saudi Arabia" src="https://raw.githubusercontent.com/AyedAlmudarra/AyedAlmudarra/main/assets/banner-light.svg" width="100%">
</picture>
...
| --- | --- | --- |
| [TerraShield](https://github.com/AyedAlmudarra/terra-shield) | Smart-ground vibration security system (Defensethon hackathon). ML classification + TDOA source localization; 95.8% human-detection accuracy on the FootprintID geophone dataset. | Python · scikit-learn · XGBoost · React |
...
- Product roadmap ownership at Wetaan (+15% platform engagement); Python/OpenCV pipelines that automated reporting (~20% efficiency gain).
- President, PSAU Cyber Security Club · Activities Committee Lead, PSAU Student Council.
- Interests: formal methods (Coloured Petri Nets), ethical ML delivery, autonomy.
...
Open to conversations about AI products, computer vision, and collaboration — [email me](mailto:AyedAlmudarra@gmail.com).
