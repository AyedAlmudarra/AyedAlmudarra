...
| [**TerraShield**](https://github.com/AyedAlmudarra/terra-shield) | Smart-ground vibration security: ML classification + TDOA localization. **95.8%** human detection on the FootprintID geophone dataset, sub-metre localization. | Python · Flask · scikit-learn · XGBoost · React |
...
![ArduPilot · Gazebo](https://img.shields.io/badge/ArduPilot_·_Gazebo-1C3D5A?style=flat)
